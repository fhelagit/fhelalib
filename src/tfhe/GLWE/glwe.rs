...
where
    [(); Polynomialsize * (Masksize + 1)]: Sized;
...
impl<const Polynomialsize: usize, const Masksize: usize> Display
    for GLWECiphertext<Polynomialsize, Masksize>
where
    [(); Polynomialsize * (Masksize + 1)]: Sized,
{
...
impl<const Polynomialsize: usize, const Masksize: usize> FromStr
    for GLWECiphertext<Polynomialsize, Masksize>
where
    [(); Polynomialsize * (Masksize + 1)]: Sized,
{
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        Ok(GLWECiphertext::from_polynomial_list(Box::new(
