use crate::{math::polynomial::polynomial::Polynomial, random::random::rnd_u64_uniform_binary, tfhe::glwe::GLWECiphertext};
use crate::tfhe::{GLEV_B, GLWE_Q};


pub struct GLWE_secret_key<const Polynomialsize: usize, const Masksize: usize>([u64; Polynomialsize * Masksize])
where
