use crate::tfhe::{ggsw::ggsw::GGSWCiphertext, schemas::{LWE_CT_Params, TFHESchema}};
use std::fmt::{self, Display};
use std::str::FromStr;

pub struct BootstrappingKey<S: TFHESchema, P: LWE_CT_Params<S>>(
    Vec<GGSWCiphertext <S, P>>,
);
